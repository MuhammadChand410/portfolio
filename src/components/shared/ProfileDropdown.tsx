...
export default function ProfileDropdown({ logout, user, clearUser }: ProfileDropdownProps) {
  ...
  return (
    <div ref={ref} className="relative">
      {/* Trigger: avatar + email/role — both open the dropdown */}
      <div
        className="flex items-center gap-3 cursor-pointer"
        onClick={() => setOpen((o) => !o)}
      >
        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-violet-600 to-purple-800 flex items-center justify-center text-white text-xs font-bold ring-2 ring-transparent hover:ring-violet-500 transition-all">
          {initials}
          {/* MA */}
        </div>
